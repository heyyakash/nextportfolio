  ...
  return (
    <div className='md:h-[250px] md:mt-10 mt-5 w-full flex items-center flex-col-reverse md:flex-row pl-6 gap-10 md:gap-0 md:p-0 justify-between'>
      <div className='flex flex-col h-full'>
        <h2 className='text-[3.75rem] md:text-[3.75rem] leading-[4rem] md:leading-[3.5rem] bg-gradient-to-r  background-animate from-[#ff1b6b] via-[#c471ed] to-[#45caff] bg-clip-text font-[600] font-montserrat text-transparent'>Akash Sharma</h2>
        ...
        <div className='flex mt-2 gap-[.1rem]'>
          ...
          <a href="https://www.twitter.com/heyyakash" rel = "noopenner norefferer" target = "_blank" className='text-xl hover:text-white p-1 hover:bg-gray-700 rounded-lg transitionAll'><FaLinkedinIn /></a>
          <a href="https://www.twitter.com/heyyakash" rel = "noopenner norefferer" target = "_blank" className='text-xl hover:text-white p-1 hover:bg-gray-700 rounded-lg transitionAll'><AiFillGithub /></a>
        </div>
      </div>
